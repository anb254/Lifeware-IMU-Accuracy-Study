...
Custom Matlab codes (Matlab R2023b) used to derive results discussed in 'Assessing the the reliability and validity of inertial measurement units to measure three-dimensional spine and hip kinematics during clinical movement tasks'
